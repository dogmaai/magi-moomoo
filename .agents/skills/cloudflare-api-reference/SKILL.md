...
description: Cloudflare API reference for Abuse Reports and Mitigations endpoints. Covers submitting, listing, and reviewing abuse reports and mitigations via the Cloudflare API.
---
